...
- (void)baseInit {
    _notSelectedStar = [UIImage imageNamed:@"not_selected_star@2x"];
    _selectedStar = [UIImage imageNamed:@"selected_star@2x"];
    _halfSelectedStar = [UIImage imageNamed:@"half_selected_star@2x"];
